...
const TopBar = ({ 
  ...
  return (
    <header className="h-20 bg-slate-950/20 backdrop-blur-xl border-b border-white/5 sticky top-0 z-30">
      <div className="max-w-[1600px] mx-auto h-full flex items-center justify-between px-6">
        <div className="flex items-center gap-6">
          ...
          {activeTab !== 'processor' && (
            <div className="hidden md:flex items-center gap-3 bg-white/[0.03] border border-white/5 rounded-xl px-4 py-2 w-48 group focus-within:border-indigo-500/50 transition-all">
