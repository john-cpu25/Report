    ...
    return (
        ...
        >
            ...
            <video
                ...
                src={`${import.meta.env.BASE_URL}intro_login.mp4`}
            />
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none" style={{ paddingLeft: '10px' }}>
                                <Mail
                                    size={18}
                                    style={{
                                        color: emailFocused ? '#60a5fa' : 'rgba(255,255,255,0.5)',
                            ...
                            <input
                                ...
                                required
                                className="w-full pr-4 text-white placeholder-white/50 outline-none"
                                style={{
                                    height: '48px',
                                    borderRadius: '5px',
                                    paddingLeft: '38px',
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none" style={{ paddingLeft: '10px' }}>
                                <Lock
                                    size={18}
                                    style={{
                                        color: passFocused ? '#60a5fa' : 'rgba(255,255,255,0.5)',
                                        transition: 'color 0.25s',
                                    }}
                                />
                            </div>
                            <input
                                ...
                                required
                                className="w-full pr-14 text-white placeholder-white/50 outline-none"
                                style={{
                                    height: '48px',
                                    borderRadius: '5px',
                                    paddingLeft: '38px',
                            ...
                            <button
                                ...
                                className="absolute inset-y-0 right-0 flex items-center group"
