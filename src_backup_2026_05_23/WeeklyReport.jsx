...
const WeeklyReport = ({ exportExcel }) => {
  ...
  return (
    <div className="tab-weekly relative min-h-screen pt-[10px] pr-[10px] pb-[10px] pl-[10px]">
      <div className="w-full mx-auto pb-[10px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[10px] items-start">
          ...
          <div className="lg:col-span-9 flex flex-col gap-[10px]">
            ...
            {weeklyViewMode === 'list' ? (
              <div className="bg-[var(--bg-card)] rounded-[8px] border border-[var(--border)] shadow-2xl overflow-hidden">
