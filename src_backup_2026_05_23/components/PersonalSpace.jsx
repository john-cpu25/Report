...
const PersonalSpace = () => {
  ...
  return (
    <div className="tab-personal w-full flex flex-col gap-[10px] animate-in fade-in duration-700 pb-[10px]">
      ...
      {/* Header */}
      <div className="bg-[var(--bg-card)] px-[10px] py-[16px] rounded-[12px] border border-[var(--border)] shadow-xl">
      ...
      {viewMode !== 'deep-analysis' && (
        <div className="ocd-card p-0 shadow-xl border border-indigo-500/20 bg-[var(--bg-card)] relative z-[38]">
      ...
      {viewMode === 'neural-brain' && (
        <NeuralBrain filteredTasks={filteredData} />
      )}
      </div>
    </div>
  );
