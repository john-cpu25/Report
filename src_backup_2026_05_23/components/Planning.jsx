...
const Planning = ({ reportData = [], weekDates = [] }) => {
  ...
  return (
    <div className={`tab-planning w-full mx-auto pb-20 transition-all duration-500 ${isExpanded ? 'px-0' : 'sys-px'}`}>
      {/* Header Controls */}
      <div className="flex flex-col md:flex-row md:items-center justify-between sys-gap mb-[10px]">
        <div>{/* Empty div to push navigation to the right */}</div>        {/* Date Navigation */}
